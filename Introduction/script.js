...
const app = createApp({
  data() {
    return {
      // Gallery array with Profile Picture + 4 Midterm Images
      manyFoods: [
        { 
      ...
      newItemName: '',
      skillsList: [
        { name: 'HTML5', found: true },
        { name: 'CSS3', found: true },
        { name: 'JavaScript', found: false },
        { name: 'Vue.js', found: false }
      ]
    }
  },
  methods: {
    addSkill() {
      if (this.newItemName.trim() !== '') {
        this.skillsList.push({ name: this.newItemName, found: false });
        this.newItemName = '';
      }
    },
    triggerMotivation() {
